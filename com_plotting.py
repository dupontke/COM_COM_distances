...
for i in range(nSel):
	...
	out1 = open('%02d.%s.%s.COM.prob_density_hist.dat' %(i,selection,system),'w')
	...
	plot_1d(half_bin,prob,'k','COM Distance','Probability Density','%02d.%s.%s' %(i,selection,system),'COM_prob_density',xunits='$\AA$')
